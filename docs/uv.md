...
Below is a clear, structured explanation of **how uv works once it is installed**, **what it sets up**, and **how to use it with a project that already has a $pyproject.toml$**.

I’ll keep the workflow minimal and practical for Windows.
