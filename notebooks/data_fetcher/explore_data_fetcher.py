...
RUN_CONFIG = {
    ...
    'fetch_all_games': True,        # Step 3: Fetch ALL games (new method!)
    ...
    'process_and_save': True,       # Step 7: Process and save to CSV
...
if RUN_CONFIG['fetch_all_games']:
    ...
    print(f"\n⚙️  Fetching last {FETCH_LIMIT_MONTHS} months of games...")
...
if RUN_CONFIG['process_and_save']:
    ...
    if 'all_games' in locals() and all_games:
        print(f"\nℹ️  Processing {len(all_games)} games from fetch_all_games()...")
